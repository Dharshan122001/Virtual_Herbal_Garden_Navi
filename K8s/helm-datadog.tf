        ...
        processors = {
          ...
          resource = {
            attributes = [
              ...
              { key = "instrumentation.provider", value = "opentelemetry", action = "insert" }
            ]
          }
        }
        exporters = {
          datadog = {
            #  FIXED: Natively nests site parameters within the authenticated API mapping engine blocks
            api = {
